...
func emptyMassivesInFunc(massivString: [String]) {
    var emptyMassiv = massivString
    if emptyMassiv.isEmpty {
        emptyMassiv.append("Новый элемент")
        
    }
    print(emptyMassiv)
}
emptyMassivesInFunc(massivString: [])
